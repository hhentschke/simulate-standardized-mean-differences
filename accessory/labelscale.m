...
tmp1=get(0,'DefaultaxesLineWidth');
tmp2=get(0,'FactoryAxesTickLength');
...
if verbose,
  disp(['DefaultaxesLineWidth=' num2str(get(0,'DefaultaxesLineWidth'))]);
  disp(['DefaultLineLineWidth=' num2str(get(0,'DefaultLineLineWidth'))]);  
end